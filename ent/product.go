...
func (e ProductEdges) CreatedByOrErr() ([]*User, error) {
	if e.loadedTypes[0] {
...
// QueryCreatedBy queries the "created_by" edge of the Product entity.
func (pr *Product) QueryCreatedBy() *UserQuery {
	return (&ProductClient{config: pr.config}).QueryCreatedBy(pr)
}
