...
func (pc *ProductCreate) AddCreatedByIDs(ids ...int) *ProductCreate {
	pc.mutation.AddCreatedByIDs(ids...)
	return pc
}

// AddCreatedBy adds the "created_by" edges to the User entity.
func (pc *ProductCreate) AddCreatedBy(u ...*User) *ProductCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return pc.AddCreatedByIDs(ids...)
}
